    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-16">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="w-[95vw] sm:max-w-lg bg-background border shadow-xl rounded-3xl p-4 sm:p-6 max-h-[95vh] overflow-y-auto scrollbar-hide">
            <DialogHeader>
      ...
      <Dialog open={editingItem?._id !== undefined && editingItem?._id !== null} onOpenChange={(open) => !open && setEditingItem(null)}>
        {editingItem && (
          <DialogContent className="w-[95vw] sm:max-w-2xl bg-background border shadow-xl rounded-3xl p-4 sm:p-8 max-h-[95vh] overflow-y-auto scrollbar-hide">
            <DialogHeader>
